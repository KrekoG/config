...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_GMAIL_USERNAME="gergely.kreko"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_GMAIL_PASSWORD="vkcl wqbx uiax wcux"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_GMAIL_SERVER="nixs.com"
	# How often in minutes to check for new mails.
	export TMUX_POWERLINE_SEG_MAILCOUNT_GMAIL_INTERVAL="5"
	
	## Maildir
	# Path to the maildir to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/gergely-kreko/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/gergely-kreko/.mailcheckrc"
# }
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="47"
	TMUX_POWERLINE_SEG_WEATHER_LON="19"
# }
